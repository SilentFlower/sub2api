...
// NewAccountUsageService 创建账号用量服务实例。
//
// @param accountRepo 账号仓储
// @param usageLogRepo 用量日志仓储
// @param usageFetcher Claude 用量获取器
// @param geminiQuotaService Gemini 配额服务
// @param antigravityQuotaFetcher Antigravity 配额获取器
// @param grokQuotaFetcher Grok 配额获取器
// @param grokQuotaService Grok 主 Billing 探测服务
// @param openAIQuotaService OpenAI 配额服务
// @param cache 用量缓存
