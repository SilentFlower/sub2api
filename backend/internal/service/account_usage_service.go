...
type UsageInfo struct {
	...
	GrokBillingQuota       *billingquota.Snapshot `json:"grok_billing_quota,omitempty"`
...
// NewAccountUsageService 创建账号使用量查询服务。
// @param accountRepo 账号仓储。
// @param usageLogRepo 使用记录仓储。
// @param usageFetcher Claude 使用量获取器。
...
func (s *AccountUsageService) getGrokUsage(ctx context.Context, account *Account, _ bool) (*UsageInfo, error) {
