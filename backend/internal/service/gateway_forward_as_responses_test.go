...
func TestHandleResponsesBufferedStreamingResponse_PreservesWebSearch(t *testing.T) {
	...
	result, err := (&GatewayService{}).handleResponsesBufferedStreamingResponse(resp, c, "deepseek-v4-pro", "deepseek-v4-pro", nil, time.Now(), apicompat.ResponsesClientToolMapping{})
	require.NoError(t, err)
	require.NotNil(t, result)
...
func TestHandleResponsesStreamingResponse_PreservesWebSearch(t *testing.T) {
	...
	result, err := (&GatewayService{}).handleResponsesStreamingResponse(resp, c, "deepseek-v4-pro", "deepseek-v4-pro", nil, time.Now(), apicompat.ResponsesClientToolMapping{})
	require.NoError(t, err)
	require.NotNil(t, result)
