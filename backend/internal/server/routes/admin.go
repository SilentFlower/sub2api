...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/:id/openai-codex-reset/status", h.Admin.Account.GetOpenAICodexResetStatus)
		accounts.POST("/:id/openai-codex-reset/consume", h.Admin.Account.ConsumeOpenAICodexResetCredit)
		accounts.POST("/:id/openai-codex-reset/invite", h.Admin.Account.SendOpenAICodexInvites)
...
func registerGrokOAuthRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	grok := admin.Group("/grok")
	{
		...
		grok.GET("/accounts/:id/billing-quota", h.Admin.GrokOAuth.QueryBillingQuota)
