...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAICodexResetClient := repository.NewOpenAICodexResetClient()
	openAICodexResetService := service.NewOpenAICodexResetService(accountRepository, proxyRepository, openAICodexResetClient, settingService)
	...
	accountHandler := admin.ProvideAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, rateLimitService, accountUsageService, accountTestService, openAICodexResetService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, grokQuotaService)
	...
	grokBillingQuotaService := service.ProvideGrokBillingQuotaService(accountRepository, proxyRepository, grokTokenProvider, httpUpstream)
	...
	grokOAuthHandler := admin.NewGrokOAuthHandler(grokOAuthService, adminService, grokQuotaService, grokBillingQuotaService, tokenRefreshService)
