...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	antigravityLSManager := service.ProvideAntigravityLSManager(configConfig)
	antigravityLSGatewayService := service.NewAntigravityLSGatewayService(antigravityTokenProvider, antigravityLSManager)
	antigravityGatewayService := service.NewAntigravityGatewayService(accountRepository, gatewayCache, schedulerSnapshotService, antigravityTokenProvider, rateLimitService, httpUpstream, settingService)
	accountTestService := service.NewAccountTestService(accountRepository, geminiTokenProvider, antigravityGatewayService, antigravityLSGatewayService, httpUpstream, configConfig)
	...
	gatewayHandler := handler.NewGatewayHandler(gatewayService, geminiMessagesCompatService, antigravityGatewayService, antigravityLSGatewayService, userService, concurrencyService, billingCacheService, usageService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, userMessageQueueService, configConfig, settingService)
