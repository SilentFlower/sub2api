...
import WebSearchEmulationSettings from "@/features/webSearch/WebSearchEmulationSettings.vue";
...
const webSearchEmulationSettingsRef =
  ref<InstanceType<typeof WebSearchEmulationSettings> | null>(null);
...
async function loadSettings() {
  ...
  try {
    ...
    form.openai_responses_lite_header_blocked_models = Array.isArray(
...
async function saveSettings() {
  ...
  try {
    ...
    const wsOk = await (
      webSearchEmulationSettingsRef.value?.save() ?? Promise.resolve(true)
    );
