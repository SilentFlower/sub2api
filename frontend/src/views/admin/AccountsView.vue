<template>
  <AppLayout>
    ...
    <OpenAICodexResetModal :show="showOpenAICodexReset" :account="openAICodexResetAcc" @close="closeOpenAICodexResetModal" />
    <AccountActionMenu :show="menu.show" :account="menu.acc" :position="menu.pos" @close="menu.show = false" @test="handleTest" @stats="handleViewStats" @schedule="handleSchedule" @reauth="handleReAuth" @refresh-token="handleRefresh" @recover-state="handleRecoverState" @reset-quota="handleResetQuota" @set-privacy="handleSetPrivacy" @openai-codex-reset="handleOpenAICodexReset" @create-spark-shadow="handleCreateSparkShadow" />
...
const showOpenAICodexReset = ref(false)
...
const openAICodexResetAcc = ref<Account | null>(null)
...
const syncAccountRefs = (nextAccount: Account) => {
  ...
  if (openAICodexResetAcc.value?.id === nextAccount.id) openAICodexResetAcc.value = nextAccount
...
const closeOpenAICodexResetModal = () => { showOpenAICodexReset.value = false; openAICodexResetAcc.value = null }
const closeReAuthModal = () => { showReAuth.value = false; reAuthAcc.value = null }
const handleTest = (a: Account) => { testingAcc.value = a; showTest.value = true }
const handleViewStats = (a: Account) => { statsAcc.value = a; showStats.value = true }
const handleOpenAICodexReset = (a: Account) => { openAICodexResetAcc.value = a; showOpenAICodexReset.value = true }
