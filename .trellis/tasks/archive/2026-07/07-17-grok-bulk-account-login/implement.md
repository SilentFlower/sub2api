...
- [x] 修复 0.2.19 最终授权页自动点击不可伪造的问题：保留邮箱、密码和设备码自动化；识别 “授权 Grok Build” / “Authorize Grok Build” 后只提示用户手动点击“允许/继续”，控制台继续轮询 Token，避免用户脚本合成点击触发 `Invalid action`。
...
- 若后续出现 “授权 Grok Build” / “Authorize Grok Build” 页面，脚本应显示“请在 xAI 授权页手动点击允许/继续”，不得自动点击“允许”/“Allow”/“继续”/“Continue”；用户手动点击后控制台继续轮询 Token，如果 RT 很快返回，控制台应保留页面约 5 秒后再进入成功和清理。授权页位于 `/oauth2/device/approve` 时不得因脚本自动点击显示 `Invalid action`。
